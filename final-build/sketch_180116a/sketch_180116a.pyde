...
class Enemy:
    def __init__(self):
        ...
        self.speed1 = PVector(0,random(3,8))
        self.speed2 = PVector(0,random(1,7))
    ...
    def draw(self):
        stroke(0)
        fill(125,0,0)
        image(img4,self.pos.x,self.pos.y,self.width,self.height)
...
def draw():
    ...
    if screen == 'menu':
        ...
        for enemy in enemies:
            ...
            enemy.pos2 = PVector(enemy.pos.x + enemy.width/2, enemy.pos.y + enemy.height/2)
            ...
            if keyPressed is True and keyCode==16:
                ...
                speed.y=5
                enemy.speed1.y = random(3,8)
                enemy.speed2.y = random(1,7)
            ...
            distance = PVector.sub(enemy.pos2,plane2)    
